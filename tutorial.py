...
def tutorial():
    ...
    sleep(5)
    print("The quotes are inside the parentheses in the 'print()' statement. Ot will then print the statement.")
    sleep(6)
    ...
    sleep(5)
    print("You can simply type 'tutorial()' into python, and then the function/code will run.")
    sleep(7)
